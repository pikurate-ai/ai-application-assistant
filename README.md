# AI 기반 정부지원과제 자동 작성 도우미 (Government Grant Application Assistant)

## 프로젝트 배경
**피큐레잇(Pikurate)** - 6년차 기술 스타트업 (자체개발 KMS 기반 AI 챗봇 에이전트 빌더)

## 프로젝트 개요
정부지원과제 지원서 작성을 자동화하는 웹 서비스 MVP. 기존 작성했던 지원서 데이터를 기반으로 새로운 정부과제 양식에 맞춘 최적의 답변을 LLM을 활용하여 자동 생성하고 Google Docs로 출력합니다.

## 핵심 기능
- 새로운 정부지원과제 신청서 질문 항목 및 분량 제한 입력
- 기존 작성한 정부과제 지원서 텍스트 데이터 입력
- LLM 기반 질문 의도 파악 및 내용 생성 (회사 소개, 기술력, 사업계획 등)
- 중복 방지 및 분량 자동 조절
- Google Docs 문서로 결과 출력

## 주요 활용 분야
- R&D 과제 신청서 (중소벤처기업부, 과기정통부 등)
- 정부지원사업 지원서 (창업지원금, 기술개발지원 등)
- 각종 정부 공모사업 신청서
